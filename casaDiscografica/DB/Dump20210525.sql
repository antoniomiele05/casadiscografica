...
CREATE TABLE `esecuzione` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKbqnjgrpxn4xd9bggggh45yeaa` (`artista_id`),
  CONSTRAINT `FKbqnjgrpxn4xd9bggggh45yeaa` FOREIGN KEY (`artista_id`) REFERENCES `artista` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `persona` VALUES (1,'Winehouse','Amy'),(2,'Winehouse','Amy'),(3,'Winehouse','Amy'),(4,'De Andrè','Fabrizio');
...
-- Dump completed on 2021-05-25 12:06:14
